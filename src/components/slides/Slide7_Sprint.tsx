...
const Slide7_Sprint: React.FC = () => {
  return (
    <div className="w-full h-full flex flex-col justify-center items-center text-center p-8">
      ...
      >
        <motion.div
          className="absolute inset-0 border-[12px] border-gray-200 rounded-full"
        />
        <motion.div
          className="absolute inset-0 border-[12px] border-t-blue-600 border-l-blue-600 border-b-blue-600/0 border-r-blue-600/0 rounded-full"
          animate={{ rotate: 360 }}
          transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
        />
        <div className="absolute inset-0 flex justify-center items-center text-5xl font-black text-blue-600">
          1-4 Semanas
        </div>
      </motion.div>
    </div>
